...
este servicio </p>
{space10}
<center>{button size="large" caption="Donar" href="http://apretaste.com/bienvenido#donate"}</center>
{space10}
<p>Nuevamente gracias por ayudar a un Cubano a tener Internet.</p>
<center>{button color="blue" size="large" caption="S&iacute;guenos en Facebook" href="http://facebook.com/apretaste"}</center>