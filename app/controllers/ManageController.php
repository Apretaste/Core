...
*/
    ...
    public function contestsAddPostAction()
    {
        ...
        $sql = "INSERT INTO _concurso (id, title, body, end_date, prize) VALUES ('$id', '$title','$body','$end_date $end_hour','$prize');";
    ...
    public function contestsEditPostAction($id)
    {
        ...
        if (isset($r[0]))
        {
            ...
            // 3. save concurso
            $sql = "UPDATE _concurso SET title = '$title', end_date = '$end_date $end_hour', body='$body', prize='$prize',  winner1 = '$winner1', winner2 = '$winner2', winner3 = '$winner3' WHERE id = '$id';";
