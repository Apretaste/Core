...
class PizarraTask extends \Phalcon\Cli\Task
{
	...
	/**
	 * Remove all accents and weirs characters from Spanish
	 * 
	 * @author dynamic
	 * @path http://stackoverflow.com/questions/1017599/how-do-i-remove-accents-from-characters-in-a-php-string
	 * @param String
	 * @return String
	 * */
